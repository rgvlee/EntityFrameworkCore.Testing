...
namespace EntityFrameworkCore.Testing.NSubstitute.Extensions
{
    ...
    public static class DbSetExtensions
    {
            ...
            where TEntity : class
        {
            ...
            ((IAsyncEnumerableAccessor<TEntity>) mockedDbSet).AsyncEnumerable.Returns(((IAsyncEnumerableAccessor<TEntity>) dbSet).AsyncEnumerable);
            ...
            ((IListSource) mockedDbSet).ContainsListCollection.Returns(((IListSource) dbSet).ContainsListCollection);

            ((IQueryable<TEntity>) mockedDbSet).ElementType.Returns(((IQueryable<TEntity>) dbSet).ElementType);
            ((IQueryable<TEntity>) mockedDbSet).Expression.Returns(((IQueryable<TEntity>) dbSet).Expression);
            ...
            ((IInfrastructure<IServiceProvider>) mockedDbSet).Instance.Returns(((IInfrastructure<IServiceProvider>) dbSet).Instance);

            mockedDbSet.Local.Returns(dbSet.Local);
