...
namespace EntityFrameworkCore.Testing.Moq.Helpers
{
    ...
    public static class Create
    {
        ...
        /// <returns>A mocked db context.</returns>
        [Obsolete("This will be removed in a future version. Use EntityFrameworkCore.Testing.Moq.Create.MockedDbContextUsingResultFrom instead.")]
        ...
        [Obsolete("This will be removed in a future version. Use EntityFrameworkCore.Testing.Moq.Create.MockedReadOnlyDbSetFor instead.")]
        public static DbSet<TEntity> MockedReadOnlyDbSetFor<TEntity>(DbSet<TEntity> readOnlyDbSet)
            where TEntity : class
        {
            return Moq.Create.MockedReadOnlyDbSetFor(readOnlyDbSet);
        }
