...
namespace EntityFrameworkCore.Testing.Common.Tests
{
        ...
        where TQuery : TestEntityBase
    {
        ...
        public override void FromSql_QueryProviderWithManyFromSqlResults_ReturnsExpectedResults()
        {
            ...
            var actualResult5 = DbQuery.FromSql("[dbo].[sp_WithParams]", new List<SqlParameter> {new SqlParameter("@someparameter2", "value2")}.ToArray()).ToList();
            Logger.LogDebug("actualResult6");
            var actualResult6 = DbQuery.FromSql("sp_WithParams @SomeParameter1 @SomeParameter2", new List<SqlParameter> {new SqlParameter("@someparameter2", "value2")}.ToArray()).ToList();
